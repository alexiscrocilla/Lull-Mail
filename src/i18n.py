...
_STRINGS: dict[str, dict[str, str]] = {
    "fr": {
        ...
        "assistant.ai_disabled":        "IA désactivée. Activez-la dans Réglages > Intelligence artificielle pour utiliser l'assistant.",
        "assistant.failed":             "L'assistant a rencontré une erreur.",
    ...
    "en": {
        ...
        "assistant.ai_disabled":        "AI is off. Enable it in Settings > AI to use the assistant.",
        "assistant.failed":             "The assistant hit an error.",
